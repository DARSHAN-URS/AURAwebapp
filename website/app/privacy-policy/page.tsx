    ...
    <div className="bg-white pt-32 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose prose-blue max-w-none text-sm sm:text-base text-gray-600 flex flex-col gap-6 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-6 mb-2">2. How We Utilize Your Data</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-6 mb-2">4. Data Protection & Security</h2>
          <p>
