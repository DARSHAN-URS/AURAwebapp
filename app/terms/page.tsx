    ...
    <div className="bg-card pt-32 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose prose-blue max-w-none text-sm sm:text-base text-muted-foreground flex flex-col gap-6 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-foreground mt-6 mb-2">1. Use of AI Tools & Matchers</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-6 mb-2">2. Accuracy of Submitted Information</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-6 mb-2">3. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-6 mb-2">4. Third-Party Links & Partner Platforms</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-6 mb-2">5. Agreement Modifications</h2>
          <p>
