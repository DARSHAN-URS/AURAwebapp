    ...
    <div className="bg-card min-h-screen pt-32 pb-24" id="print-area">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12 border-b border-border pb-6">
          <div>
            <h1 className="text-3xl font-extrabold text-foreground tracking-tight">AI Scholarship Finder</h1>
            <p className="text-xs sm:text-sm text-muted-text mt-1">Discover grants, calculate tuition gap roadmaps, and compile financial plans.</p>
          </div>
        ...
        {loading && (
          <div className="fixed inset-0 bg-card/95 backdrop-blur-sm z-50 flex items-center justify-center">
            <div className="flex flex-col items-center gap-6 max-w-sm text-center px-6">
              ...
              <div>
                <h3 className="font-extrabold text-xl text-foreground mb-2">Finding Scholarships</h3>
        ...
        <div className="flex items-center gap-2 bg-background/50 border border-border rounded-2xl p-2 mb-8 no-print">
          <Button
            variant="ghost"
            onClick={() => setActiveTab("finder")}
            className={`h-9 px-4 rounded-xl text-xs font-bold cursor-pointer ${
              activeTab === "finder" ? "bg-card text-primary shadow-sm border border-border/20" : "text-muted-foreground"
            }`}
          >
            Scholarship Finder
          </Button>
          ...
          <Button
            ...
            className={`h-9 px-4 rounded-xl text-xs font-bold cursor-pointer ${
              activeTab === "planner" ? "bg-card text-primary shadow-sm border border-border/20" : "text-muted-foreground"
            }`}
          >
            Funding Planner
          </Button>
              ...
              <div className="bg-card border border-border rounded-3xl p-6 sm:p-10 shadow-2xl">
                <form onSubmit={handleFindScholarships} className="flex flex-col gap-6">
                  <div className="border-b border-gray-50 pb-4">
                    ...
                    <p className="text-xs text-muted-text mt-1">Please provide academic achievements to evaluate match likelihood.</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] font-bold text-muted-text uppercase">Residence Country</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] font-bold text-muted-text uppercase">Annual Family Income</label>
                      <input
                        type="text"
                        value={income}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <select
                        ...
                        className="bg-background border border-border rounded-xl px-4 py-3 text-xs focus:outline-none font-bold"
                      >
                  ...
                  <div className="flex flex-wrap gap-4 bg-gray-55/40 p-4 rounded-2xl border border-border">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="bg-card border border-border rounded-2xl p-4 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4 no-print">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <select
                      ...
                      className="bg-background border border-border rounded-lg px-2.5 py-1 text-xs focus:outline-none font-bold"
                    >
                  ...
                  {filteredMatches.map((uni, idx) => {
                    ...
                    return (
                      <div 
                        ...
                        className="bg-card border border-border rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col justify-between relative overflow-hidden"
                      >
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 border-b border-gray-50 pb-4 mb-6">
                          ...
                          <div className="flex items-center gap-2 bg-primary/10/30 border border-primary/20 px-3 py-1.5 rounded-full shrink-0">
                            ...
                            <span className="text-sm font-black text-primary">{uni.ai_match_percentage}% Eligibility Fit</span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                          <div className="flex flex-col gap-4">
                            <div>
                              <span className="text-[10px] font-bold text-muted-text uppercase">Funding Amount & Period:</span>
                              <p className="text-xs sm:text-sm font-semibold text-foreground/80 mt-0.5">{uni.funding_amount}</p>
                            </div>
                            <div>
                              <span className="text-[10px] font-bold text-muted-text uppercase">Coverage Scope:</span>
                              <p className="text-xs sm:text-sm font-semibold text-foreground/80 mt-0.5">{uni.coverage}</p>
                            </div>
                            <div>
                              <span className="text-[10px] font-bold text-muted-text uppercase">Application Deadline:</span>
                          ...
                          <div className="flex flex-col gap-4">
                            <div>
                              <span className="text-[10px] font-bold text-muted-text uppercase">Eligibility Criteria:</span>
                              <p className="text-xs sm:text-sm font-semibold text-foreground/80 mt-0.5">{uni.eligibility_criteria}</p>
                            </div>
                            <div>
                              <span className="text-[10px] font-bold text-muted-text uppercase">Required Documents:</span>
                              <p className="text-xs sm:text-sm font-semibold text-foreground/80 mt-0.5">{uni.required_documents}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-background border border-border rounded-2xl p-4 mb-6">
                          <span className="text-[10px] font-bold text-muted-text uppercase block mb-1">AI Recommendation Strategy:</span>
                          <p className="text-xs text-muted-foreground leading-relaxed font-semibold">{uni.application_strategy}</p>
                        </div>
                        ...
                        <div className="flex items-center justify-between border-t border-gray-50 pt-4 no-print">
                          ...
                          <a href={uni.website} target="_blank" className="text-xs font-bold text-primary hover:underline">
                ...
                <div className="flex items-center justify-between border-t border-border pt-8 no-print">
                  <Button
                    variant="ghost"
                    onClick={() => setMatches([])}
                    className="rounded-full px-6 text-muted-foreground flex items-center gap-1.5 cursor-pointer text-xs font-bold animate-pulse"
                  >
        ...
        {activeTab === "planner" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card border border-border rounded-3xl p-6 sm:p-8 shadow-sm lg:col-span-2">
              <form onSubmit={handleCalculateFundingRoadmap} className="flex flex-col gap-5">
                <div className="border-b border-gray-50 pb-3">
                  ...
                  <p className="text-xs text-muted-text mt-1">Estimate total study costs and available sponsorship loan coverage.</p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Tuition Fee / Year (INR)</label>
                    <input
                      type="number"
                      value={tuitionFee}
                      onChange={(e) => setTuitionFee(e.target.value)}
                      className="bg-gray-55 border border-border rounded-xl px-4 py-3 text-xs focus:outline-none focus:border-blue-600 font-medium"
                      required
                    />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Living Expenses / Year (INR)</label>
                    <input
                      type="number"
                      value={livingCost}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-5">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Travel Cost (INR)</label>
                    <input
                      type="number"
                      value={travelCost}
                      onChange={(e) => setTravelCost(e.target.value)}
                      className="bg-gray-55 border border-border rounded-xl px-4 py-3 text-xs focus:outline-none"
                    />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Visa Cost (INR)</label>
                    <input
                      type="number"
                      value={visaCost}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Insurance (INR)</label>
                    <input
                      type="number"
                      value={insurance}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Misc Expenses (INR)</label>
                    <input
                      type="number"
                      value={miscCost}
                ...
                <div className="border-t border-gray-50 pt-4 grid grid-cols-1 sm:grid-cols-3 gap-5">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Savings / Block account (INR)</label>
                    <input
                      type="number"
                      value={savingsAmt}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Education Loan Approved (INR)</label>
                    <input
                      type="number"
                      value={loanAmt}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-muted-text uppercase">Sponsor Support (INR)</label>
                    <input
                      type="number"
            ...
            <div className="bg-background border border-border rounded-3xl p-6 flex flex-col justify-between">
              <div>
                <h4 className="text-[10px] font-black uppercase text-muted-text tracking-wider mb-4">Funding Audit Roadmap</h4>

                {fundingResult ? (
                  <div className="flex flex-col gap-4">
                    <div>
                      <span className="text-[10px] text-muted-text font-bold uppercase">Estimated Total Costs:</span>
                    ...
                    <div>
                      <span className="text-[10px] text-muted-text font-bold uppercase">Available Liquid Funds:</span>
                      <p className="text-lg font-black text-foreground">
                    ...
                    <div className="bg-card border border-border p-4 rounded-xl mt-4">
                      <span className="text-[9px] text-muted-text font-bold uppercase block mb-1">Financial Safety Score:</span>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl font-black text-primary">{fundingResult.plan.readiness_score}/100</span>
                        <span className="text-[10px] font-bold text-gray-450">Safety</span>
                      </div>
                      <p className="text-[11px] text-muted-foreground leading-normal mt-3 font-semibold">{fundingResult.plan.suggested_plan}</p>
                    </div>
                  </div>
                ) : (
