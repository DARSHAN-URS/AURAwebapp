  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="border-b border-gray-50 pb-4">
        <h2 className="text-xl font-bold text-gray-950">Step 1: Personal Information</h2>
        <p className="text-xs text-gray-400 mt-1">Please provide your contact credentials to register your assessment.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-gray-400 uppercase">Country of Residence</label>
          <input
            type="text"
