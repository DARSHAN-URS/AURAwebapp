  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="border-b border-gray-50 pb-4">
        <h2 className="text-xl font-bold text-gray-950">Step 4: Study Preferences</h2>
        <p className="text-xs text-gray-400 mt-1">Specify your dream educational destination coordinates.</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-gray-400 uppercase">Preferred Target Country</label>
          <select
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-gray-400 uppercase">Preferred Course / Major</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-gray-400 uppercase">Annual Budget (Tuition + Living)</label>
          <select
      ...
      <div className="flex items-center gap-3 p-4 bg-gray-50 border border-gray-100 rounded-2xl">
        ...
        />
        <label htmlFor="scholarshipRequired" className="text-xs sm:text-sm font-semibold text-gray-700 cursor-pointer select-none">
