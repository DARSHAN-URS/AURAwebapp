  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="border-b border-gray-50 pb-4">
        <h2 className="text-xl font-bold text-foreground">Step 5: Additional Background</h2>
        <p className="text-xs text-muted-text mt-1">Provide work and passport compliance history details.</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-muted-text uppercase">Work Experience (Years)</label>
          <input
            type="number"
            step="0.1"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-muted-text uppercase">Academic Gap Years</label>
          <input
            type="number"
      ...
      {showNeet && (
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-muted-text uppercase">NEET Score (Required for MBBS abroad)</label>
          <input
            type="number"
      ...
      <div className="flex items-center gap-3 p-4 bg-background border border-border rounded-2xl">
        ...
        />
        <label htmlFor="passportAvailable" className="text-xs sm:text-sm font-semibold text-foreground/80 cursor-pointer select-none">
