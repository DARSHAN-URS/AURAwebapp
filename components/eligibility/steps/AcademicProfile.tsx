  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="border-b border-gray-50 pb-4">
        <h2 className="text-xl font-bold text-foreground">Step 2: Academic Profile</h2>
        <p className="text-xs text-muted-text mt-1">Provide your scores and graduation metrics.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-muted-text uppercase">10th Score (Percentage / GPA)</label>
          <input
            type="number"
            step="0.01"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-bold text-muted-text uppercase">12th Score (Percentage / GPA)</label>
          <input
            type="number"
            step="0.01"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        {showBachelor && (
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-muted-text uppercase">Bachelor's CGPA (Out of 10 or 4)</label>
            <input
              type="number"
              step="0.01"
        ...
        {showMaster && (
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-muted-text uppercase">Master's CGPA (Optional)</label>
            <input
              type="number"
              step="0.01"
