...
export default function Services() {
  return (
    <section className="py-24 sm:py-32 bg-card" id="services">
            ...
            return (
              ...
              >
                <Link href={service.href}>
                  <div className="bg-card rounded-3xl border border-border overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col">
                    ...
                    <div className="p-6 flex flex-col justify-between flex-1">
                      <div>
                        ...
                        <h3 className="text-sm font-black text-foreground mb-2 group-hover:text-primary transition-colors tracking-tight">
                          {service.title}
                        </h3>
                      ...
                      <div className="flex items-center gap-1.5 text-xs font-bold text-primary mt-5 group-hover:gap-2.5 transition-all">
                        Learn More
